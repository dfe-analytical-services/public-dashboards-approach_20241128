...
Team builds dashboard -> We review -> We help them publish (using GitHub actions workflows) -> Users access at URL

Existing data can come from multiple sources, EES, other sources in the department, or even outside of the department.

Aim is that most of our dashboards will just have a direct connection to the EES API once launched, currently have a proof of concept and are just conducting our final interviews on the closed testing of the EES API.
